...
if(isset($_POST['update'])){
     ...
     $textarea=$_POST['textarea'];
      ...
      $updatedata="UPDATE data SET fname='$firstname',lname='$lastname',gender='$gender',phone='$phone',
    ...
    <div class="con">
        ...
        <div class="form" >
            ...
            <div class="input_feild">
                ...
                <input type="text" class='input' value="<?php echo $result['fname']?>" name='firstname' required>
            </div>

            <div class="input_feild">
                <label >Last Name</label>
                <input type="text" class='input' value="<?php echo $result['lname']?>"  name='lastname'required>
            </div>
